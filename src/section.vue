        ...
        <div class="content">
            <div class="title-container">
                <svg class="blob" preserveAspectRatio="none" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:cc="http://creativecommons.org/ns#" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sodipodi="http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd" viewBox="0 0 1284 252">
                    ...
                    <defs id="defs49">
                        <path d="m 0,0 h 1215 c 39.3333,74.006803 39.3333,131.0068 0,171 -59,59.9898 -395.19294,50 -587.08333,50 C 499.98974,221 290.68418,208 0,182 Z" id="path-1" inkscape:connector-curvature="0"></path>
                        <filter x="-0.051999997" y="-0.33200002" width="1.104" height="1.582" filterUnits="objectBoundingBox" id="filter-2">
                            <feOffset dx="0" dy="-9" in="SourceAlpha" result="shadowOffsetOuter1" id="feOffset42"></feOffset>
                            <feGaussianBlur stdDeviation="20" in="shadowOffsetOuter1" result="shadowBlurOuter1" id="feGaussianBlur44"></feGaussianBlur>
                            <feColorMatrix values="0 0 0 0 0.443137255   0 0 0 0 0.48627451   0 0 0 0 0.537254902  0 0 0 0.5 0" type="matrix" in="shadowBlurOuter1" id="feColorMatrix46"></feColorMatrix>
                        </filter>
                    </defs>
                    <g id="01---Webeo---Desktop" transform="translate(0,-995)" style="fill:none;fill-rule:evenodd;stroke:none;stroke-width:1">
                        <g id="Group" transform="translate(0,995)">
                            <g id="Rectangle-7">
                                <use xlink:href="#path-1" id="use51" style="fill:#000000;fill-opacity:1;filter:url(#filter-2)" x="0" y="0" width="100%" height="100%"></use>
                                <use xlink:href="#path-1" id="use53" style="fill:#ffffff;fill-rule:evenodd" x="0" y="0" width="100%" height="100%"></use>
                            </g>
                        </g>
                    </g>
                </svg>
                    ...
                    <div class="card-outter" @click="wwOnClickCard(index, $event)" @mousemove="wwOnMousemove(index, $event)" @mouseout="wwOnMouseout(index, $event)" v-bind:class="'card-' + (index+1)">
                        ...
                        <div class="card">
                            <div class="card-content front">
                                <wwObject class="background" v-bind:ww-object="card.front.background" ww-category="background"></wwObject>
                            ...
                            <div class="card-content back">
                                <wwObject class="background" v-bind:ww-object="card.back.background" ww-category="background"></wwObject>
    ...
    methods: {
        ...
        migrateOldData() {
            if (this.section.data.cardsWwObject && this.section.data.cardsWwObject.length) {
                ...
                delete this.section.data.cardsWwObject;
